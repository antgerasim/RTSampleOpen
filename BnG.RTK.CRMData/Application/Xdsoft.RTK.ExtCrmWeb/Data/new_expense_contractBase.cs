namespace Xdsoft.RTK.ExtCrmWeb.Data
{
    ...
    public partial class new_expense_contractBase
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public new_expense_contractBase()
        {
        ...
        public Guid? new_link_account_expense_contract { get; set; }

        public Guid? new_link_businessunit_expense_contrac { get; set; }

        public DateTime? new_dt_works_en { get; set; }
        ...
        public bool? new_frame_contract_sign { get; set; }

        public Guid? new_link_product_group_id { get; set; }

        public Guid? new_link_sphere_of_activity_id { get; set; }

        public decimal? new_expense_contract_sum { get; set; }

        public DateTime? new_expense_contract_sum_Date { get; set; }

        public int? new_expense_contract_sum_State { get; set; }
