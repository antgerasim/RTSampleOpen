namespace Xdsoft.RTK.ExtCrmWeb.Data
{
    ...
    public partial class new_initiative_probabilityBase
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public new_initiative_probabilityBase()
        {
            new_project_initiativeBase = new HashSet<new_project_initiativeBase>();
        }

        [Key]
        public Guid new_initiative_probabilityId { get; set; }
        ...
        [StringLength(100)]
        public string new_probability { get; set; }
